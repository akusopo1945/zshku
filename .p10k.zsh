# Generated by Powerlevel10k configuration wizard on 2025-02-26 at 13:42 +07.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49619.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, angled separators, flat heads, sharp tails, 2 lines, dotted, no frame,
# darkest-ornaments, compact, many icons, fluent, instant_prompt=verbose.
...
# Typeset parameters controlling user@hostname segment.
typeset -g POWERLEVEL9K_SHOW_USER=true
typeset -g POWERLEVEL9K_USER_ALWAYS_SHOW=true
typeset -g POWERLEVEL9K_USER_FOREGROUND=white
typeset -g POWERLEVEL9K_USER_BACKGROUND=blue
